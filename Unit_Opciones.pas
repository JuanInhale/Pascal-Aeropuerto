...
Uses Crt,sysutils,dos,Unit_Sonido,Unit_Archivos,Unit_Validacion,Unit_Pasajero,Unit_Reserva;
...
procedure VaciarDatosVentas();
procedure VaciarDatosPasajeros();
...
Begin
ClrScr;
assign(ArchivoOriginal,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeVuelos.dat');
assign(Respaldo,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Respaldos\RespaldoVuelos.dat');
...
Begin
ClrScr;
assign(ArchivoOriginal,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeAeropuertos.dat');
assign(Respaldo,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Respaldos\RespaldoAeropuertos.dat');
reset(ArchivoOriginal);
rewrite(Respaldo);
WriteLn('Espere porfavor, estamos realizando su copia de seguridad: ');
I:=0;
...
Begin
ClrScr;
assign(ArchivoOriginal,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDePasajeros.dat');
assign(Respaldo,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Respaldos\RespaldoPasajeros.dat');
reset(ArchivoOriginal);
rewrite(Respaldo);
WriteLn('Espere porfavor, estamos realizando su copia de seguridad: ');
I:=0;
...
Begin
ClrScr;
assign(ArchivoOriginal,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeVentas.dat');
assign(Respaldo,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Respaldos\RespaldoVentas.dat');
reset(ArchivoOriginal);
rewrite(Respaldo);
WriteLn('Espere porfavor, estamos realizando su copia de seguridad: ');
I:=0;
...
Begin
ClrScr;
assign(ArchivoOriginal,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeLineasAereas.dat');
assign(Respaldo,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Respaldos\RespaldoLineasAereas.dat');
reset(ArchivoOriginal);
rewrite(Respaldo);
WriteLn('Espere porfavor, estamos realizando su copia de seguridad: ');
I:=0;
...
Begin
ClrScr;
assign(ArchivoOriginal,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeReservas.dat');
assign(Respaldo,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Respaldos\RespaldoReservas.dat');
reset(ArchivoOriginal);
rewrite(Respaldo);
WriteLn('Espere porfavor, estamos realizando su copia de seguridad: ');
I:=0;
...
begin
	...
	Erase (A_Aero);
	{$i-}
	Assign(A_Aero,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeAeropuertos.dat');
	Rewrite(A_Aero);
	{$I+}
	close(A_Aero);
	Verificar:=(IOresult)
...
begin
	...
	Erase(A_LA);
	{$i-}
	Assign(A_LA,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeLineasAereas.dat');
	Rewrite(A_LA);
	{$I+}
	close(A_LA);
	Verificar:=(IOresult);
...
begin
	...
	Erase(A_Vue);
	{$i-}
	Assign(A_Vue,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeVuelos.dat');
	Rewrite(A_Vue);
	{$I+}
	close(A_Vue);
	Verificar:=(IOresult);
...
begin
	...
	Erase(A_Res);
	{$i-}
	Assign(A_Res,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeReservas.dat');
	Rewrite(A_Res);
	{$I+}
	close(A_Res);
	Verificar:=(IOresult);
...
begin
	...
	Erase(A_Pas);
	{$i-}
	Assign(A_Pas, 'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDePasajeros.dat');
	Rewrite(A_Pas);
	{$I+}
	close(A_Pas);
	Verificar:=(IOresult);
	...
	If Verificar=0 then
	begin
		writeln('Los datos de pasajeros han sido eliminados.');
	end
	else
	begin
		writeln('No se ha podido completar la operacion.');
...
begin
	...
	Erase(A_Ven);
	{$i-}
	Assign(A_Ven,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDeVentas.dat');
	Rewrite(A_Ven);
	{$I+}
	close(A_Ven);
	Verificar:=(IOresult);
	...
	If Verificar=0 then
	begin
		writeln('Los datos de Ventas han sido eliminados.');
	end
	else
	begin
		writeln('No se ha podido completar la operacion.');
