...
Begin
     ...
     Begin
          ...
          Begin
               ...
               writeln('aca',R_Vue.ID_Vuelo);
               If (aeropuerto=R_Vue.Origen) then
               begin
                    writeln('aca tambien',R_Vue.ID_Vuelo);
                    GotoXY(2,pos);
...
Begin
     ...
     Begin
          ...
          Begin
               ...
               MS2:= copy(Fecha2,6,2);
               AS2:= copy(Fecha2,1,4);
               DSP:= copy(R_Vue.FechaP,9,2);
               //writeln(dsp);
               MSP:= copy(R_Vue.FechaP,6,2);
               //writeln(msp);
               ASP:= copy(R_Vue.FechaP,1,4);
               val(DS1,DI1,codigo);
               val(MS1,MI1,codigo);
               val(AS1,AI1,codigo);
               val(DS2,DI2,codigo);
               ...
               //writeln('MS2:',MI2);
               //     readln();
               If (Aerolinea=R_Vue.ID_LineaAerea) and ((AI1<=AIP) and (AI2>=AIP))
                                                  and (
                                                      ((MI1<MIP) and (MI2>MIP))or
                                                      ((MI1=MIP)and(DIP>=DI1))or
                                                      ((MIP=MI2)and(DIP<=DI2))or
                                                      ((MI1=12) and(MIP<MI2))
                                                      ) then
               // El MS1 es 12 y el MS2 es 05, anda viendo que el MS1 es mayor al MS2
               begin
                    GotoXY(2,pos);
                    Writeln(R_Vue.ID_Vuelo);
                    GotoXY(11,pos);
