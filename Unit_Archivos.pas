...
Procedure Busqueda_LA(var A_LA:ArchivoLineaAerea; Bus:string; var Pos:integer;var R_LA:TipoLineaAerea);
...
Procedure Abrir_P(var A_Pasaj:ArchivoPasajero);
begin
     Assign(A_Pasaj,'C:\Users\toshiba1\Desktop\final\Dev-Pas\Datos\DatosDePasajeros.dat');
     Reset(A_Pasaj);
     If (ioresult <> 0) then
     Rewrite(A_Pasaj);
end;
